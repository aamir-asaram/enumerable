...
# 📖 Enumerabler <a name="about-project"></a>

**Enumerable** is a project that involves filtering data based on boolean criteria and/or a specified filter method
...
```sh
  cd my-folder
  git clone https://github.com/aamir-asaram/enumerable.git
```
